...
class QIBA_table_model_T1(object):
    ...
    def __init__(self, data_table_T1, allowable_total_error):
        ...
        self.ref_cal_T1_groups = self.groupRefCalByRefValue(self.ref_T1_list, self.cal_T1_list, self.number_T1_inst_list, self.number_usable_T1_list, self.param_weights_T1_list)
